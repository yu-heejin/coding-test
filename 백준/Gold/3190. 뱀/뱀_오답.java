...
public class Main {
    ...
    private static int playGame(int[][] board, String[][] directions) {
        ...
        while (true) {
            System.out.println("current time is " + time + ", Head Position: " + Arrays.toString(currentPosition) + ", curret direction: " + currentDirection);
            for (int j = 1; j <= N; j++) {
                for (int k = 1; k <= N; k++) {
            ...
            System.out.println("next: " + Arrays.toString(nextPosition));
